...
public:
	...
	constexpr Color( unsigned int dw )
		...
		dword( dw )
	{}
	constexpr Color( unsigned char x,unsigned char r,unsigned char g,unsigned char x0 )
		:
		dword( (x << 24u) | (r << 16u) | (g << 8u) | x0 )
	{}
	constexpr Color( unsigned char r,unsigned char g,unsigned char x0 )
		:
		dword( (r << 16u) | (g << 8u) | x0 )
	{}
	...
	void SetB( unsigned char x0 )
	{
		dword = (dword & 0xFFFFFF00u) | x0;
	}
};

namespace Colors
{
	static constexpr Color MakeRGB( unsigned char r,unsigned char g,unsigned char x0 )
	{
		return (r << 16) | (g << 8) | x0;
	}
